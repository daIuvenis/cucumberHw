...
//        Assert.assertTrue(DriverFactory.driver.getPageSource().contains("Re: Test"));     //3.16
...
//        action.moveByOffset(10, 10).click().build().perform();
//        Assert.assertFalse(DriverFactory.driver.getPageSource().contains("Re: Test"));        //3.19
//    }
//}
